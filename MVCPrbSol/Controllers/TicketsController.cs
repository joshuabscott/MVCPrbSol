...
namespace MVCPrbSol.Controllers
{
    ...
    public class TicketsController : Controller
    {
        ...
        public TicketsController(ApplicationDbContext context, UserManager<PSUser> userManager, IPSHistoryService historyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(string userId)
        {
            ...
            {
                projectsIds.Add(_context.Projects.Find(record.ProjectId).Id);
            }
        ...
        // GET: Tickets/Create
        [Authorize(Roles = "Administrator, ProjectManager, Developer, Submitter")]
        public IActionResult Create(int? id)
        {
            ...
            if (id == null)
            {
                ...
                else
                {
                    ...
                    var projectIds = _context.ProjectUsers.Where(pu => pu.UserId == userId).Select(pu => pu.ProjectId).ToList();
                    var projects = new List<Project>();
                    foreach (var pId in projectIds)
                    {
                        projects.Add(_context.Projects.Find(pId));
                    };
                    if (projects.Count == 0)
                    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Description,ProjectId,TicketTypeId,TicketPriorityId,TicketStatusId,DeveloperUserId")] Ticket ticket)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ticket.TicketPriorityId = _context.TicketPriorities.Where(tp => tp.Name == "Pending").FirstOrDefault().Id;
