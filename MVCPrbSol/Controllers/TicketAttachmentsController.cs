...
namespace MVCPrbSol.Controllers  //Namespace is the outermost , Inside is a class, than a method, than the logic
{
    ...
    public class TicketAttachmentsController : Controller
    {
        ...
        public TicketAttachmentsController(ApplicationDbContext context, UserManager<PSUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("FormFile,Description,TicketId")] TicketAttachment ticketAttachment)
        {
            if (ModelState.IsValid)
            {
                ...
                ticketAttachment.ContentType = ticketAttachment.FormFile.ContentType;  //Added to allow downloading
